                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="beranda.php"><img src="images/tokpet.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Selamat Datang <br></span>Di Website TokoPetani</h1>
                           <figure><img src="images/bgrn.jpg" alt="#"/></figure>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">Selamat Datang <br></span>Di Website TokoPetani</h1>
                           <figure><img src="images/dhfb.png" alt="#"/></figure>
                           <a class="read_more" href="#">Belanja Sekarang</a>
                        </div>
                     </div>
                  </div>
      ...
      <div class="about">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="about_img">
                     <figure><img src="images/tokpet.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="titlepage">
                     <h2>Tentang TokoPetani</h2>
                     <p>TokoPetani adalah sebuah aplikasi penjualan sayur dan buah berbasis website .</p>
                  </div>
                  <a class="read_more" href="#">baca</a>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                     ...
                     <p>Belanja produk hemat dan sehat ya TOKOPETANI solusinya</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-md-7 padding_right0">
                  <div class="max_width">
                     <div class="titlepage">
                        <h2>Produk terbaik toko kami</h2>
                        ...
                        <a class="read_more" href="#">Belanja Sekarang</a>
                        <a class="read_more" href="#">Tambahkan keranjang</a>
                     </div>
                  </div>
               </div>
            </div>
                           ...
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="clients_box">
                                          <figure><img src="images/pisang.jpg" alt="#"/></figure>
                                          <h3>Sandy Mark</h3>
                                          <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,It is a long established fact  a more-or-less normal distribution of letters,</p>
                                       </div>
                                    </div>
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <input class="contactusmess" placeholder="Pesan" type="type" Message="Pesan">
                        </div>
                        <div class="col-md-12">
