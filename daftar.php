		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required 8 character until 10">
						<input class="input100" type="password" name="password" placeholder="Password" minlength="8" maxlength="10">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
